...
계속 진행하시겠습니까?`,
  ...
  const FUN_PHRASES = [
    ...
    "임채훈 야근 시키는 계획 수립 중 🌙",
    "임채훈한테 TDD 강요하는 중 🧪",
    "임채훈 코드에서 버그 찾았다... 기쁜 중 🎉",
    "임채훈 깃허브 히스토리 파헤치는 중 🕵️",
    "임채훈보다 빨리 끝내는 중 🏆",
    "임채훈의 변수명 지적할 목록 작성 중 📝",
    "임채훈이 모르게 리팩토링하는 중 🔧",
    "임채훈에게 '이건 레거시입니다' 설명하는 중 😇",
    "임채훈 없을 때 몰래 배포하는 척하는 중 🚀",
	"임채훈 커밋에서 TODO 발굴 중 ⛏️",
	"임채훈의 '간단한 수정' 분석 중 🔬",
	"임채훈 코드에 주석 추가 중 📚",
	"임채훈이 남긴 기술부채 적립 중 💳",
	"임채훈의 기술부채 상환 중 💸",
	...
	"임채훈 TODO를 Jira로 승격 중 🎫",
	"임채훈 코드에서 비즈니스 로직 찾는 중 🗺️",
	"임채훈의 if문 개수 세는 중 🔢",
	"임채훈이 왜 성공했는지 조사 중 🎲",
	"임채훈이 왜 실패했는지 더 조사 중 🤯",
	"임채훈 리뷰 요청 읽씹하는 중 🙈",
